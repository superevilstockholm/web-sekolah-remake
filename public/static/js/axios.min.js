...
!(function (e, t) {
    ...
    var je = (function () {
        ...
        Ne =
            Pe &&
            (!Le ||
                ["ReactNative", "NativeScript", "NS"].indexOf(Le.product) < 0),
        _e =
    ...
    function Fe(e) {
        function t(e, r, n, o) {
            ...
            return (
                ...
                s
                    ? (he.hasOwnProp(n, i) ? (n[i] = [n[i], r]) : (n[i] = r),
                      !a)
        ...
        transformRequest: [
            function (e, t) {
                var r,
                    ...
                    i = he.isObject(e);
                if (
                    (i && he.isHTMLForm(e) && (e = new FormData(e)),
                    he.isFormData(e))
                )
            ...
            y(
                        ...
                        value: function (e) {
                            ...
                            return (
                                he.forEach(this, function (n, o) {
                                    ...
                                    if (i)
                                        return (t[i] = ze(n)), void delete t[o];
                                    var a = e
                                        ? (function (e) {
                                              return e
                                                  .trim()
                ...
                [
                    ...
                    },
                    {
                        key: "accessor",
                        value: function (e) {
                            var t = (this[qe] = this[qe] = { accessors: {} })
                                    .accessors,
                                r = this.prototype;
                            function n(e) {
                                var n = Me(e);
        ...
        st = function (e) {
            ...
            if (
                ...
                if (
                    ...
                    Ue.hasStandardBrowserWebWorkerEnv
                )
        ...
        kt = function (e, t) {
            for (
                ...
                if (
                    ((n = r = e[a]),
                    !Rt(r) &&
                        void 0 === (n = St[(s = String(r)).toLowerCase()]))
                )
    ...
    (Pt.transitional = function (e, t, r) {
        function n(e, t) {
            return (
                "[Axios v1.12.2] Transitional option '" +
                e +
                "'" +
                t +
                (r ? ". " + r : "")
                        ...
                        value: function (e, t) {
                            ...
                            void 0 !== n &&
                                Nt.assertOptions(
                                    n,
                                    {
                                        silentJSONParsing: _t.transitional(
                                            _t.boolean
                                        ),
                                        forcedJSONParsing: _t.transitional(
                                            _t.boolean
                                        ),
                                        clarifyTimeoutError: _t.transitional(
                                            _t.boolean
                                        ),
                                    },
                                    !1
