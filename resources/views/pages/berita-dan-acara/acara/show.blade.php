        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('berita-dan-acara.berita.index') }}">Acara</a></li>
...
<script>
const slug = "{{ $slug }}";
const url = "/api/master-data/events/" + slug;
...
async function fetchEvent() {
    try {
        ...
        document.getElementById('category').innerText = (data.category === 'acara' ? 'Acara': 'Acara Berita') + " - " + data.user.name;
